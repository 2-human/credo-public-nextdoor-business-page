...
window.CREDO_ND_POSTS = [
 ...
 {date:'2026-08-31', status:'published', src:'hub', type:'edu', cluster:'Scam alert', img:'assets/post-scam.jpg', imgNote:'Hub image (16:9)',
  ...
  metrics:{views:373, reactions:0, comments:0, asOf:'2026-09-17'},
 ...
 {date:'2026-09-03', status:'published', src:'live', type:'edu', cluster:'Community reply · Clara', img:'', imgNote:'No image — a share of a neighbor\'s post',
  ...
  metrics:{views:91, reactions:0, comments:0, asOf:'2026-09-17'},
 ...
 {date:'2026-09-03', status:'published', src:'hub', type:'ad', cluster:'Medical', img:'assets/post-medical.jpg', imgNote:'Hub image (16:9)',
  ...
  metrics:{views:8, reactions:0, comments:0, asOf:'2026-09-17'},
  lp:'https://start.credolegal.com/medical-debt-bills-errors',
  text:'A surprise medical bill is worth a second look before you pay it. Medical billing is full of coding errors, duplicate charges, and amounts a collector cannot always validate. You can ask them to prove the amount first. Free review: start.credolegal.com/medical-debt-bills-errors',
 ...
 {date:'2026-09-18', time:'21:00', status:'scheduled', src:'bold', type:'ad', cluster:'Stop the calls', img:'assets/bold/stop-1x1.jpeg', imgNote:'Bold creative · "Make the debt collector calls stop?" (1:1)',
  lp:'https://start.credolegal.com/debt-harassment-stop-calls',
  text:'Want the debt collector calls to stop? You can tell a collector in writing to stop contacting you, and under the FDCPA they have to. Calls before 8am, after 9pm, or at your job after you have asked them not to can each be a violation. Our attorneys send the letter and deal with the collector so you do not have to. Free review of your calls: start.credolegal.com/debt-harassment-stop-calls',
 ...
 {date:'2026-09-19', time:'09:00', status:'scheduled', src:'hub', type:'ad', cluster:'Debt validation', img:'assets/post-validation.jpg', imgNote:'Hub image (16:9)',
  lp:'https://start.credolegal.com/debt-harassment-stop-calls',
  text:'Not sure a debt a collector is chasing is even yours? You have the right to make them validate it in writing before you pay a cent, and many collectors, especially debt buyers, cannot produce the paperwork to back it up. Here is how debt validation works: start.credolegal.com/debt-harassment-stop-calls',
  disc:['dram'], why:'Links to a landing page → advertising. Explains a right rather than promising a result → no Prior results line.'},

 {date:'2026-09-20', time:'17:00', status:'scheduled', src:'bold', type:'ad', cluster:'Brand · not alone', img:'assets/bold/heart-1x1.jpeg', imgNote:'Bold creative · "Don\'t face your debt collectors alone" (1:1)',
  lp:'https://start.credolegal.com',
  text:'Dealing with debt collectors is stressful enough without doing it alone. Credo is a debt-defense law firm: real attorneys, a flat monthly fee, and one job, which is making collectors prove what they claim and handling them so you do not have to. If you are getting calls or letters about a debt, start with a free review: start.credolegal.com',
 ...
 {date:'2026-09-23', time:'17:00', status:'scheduled', src:'bold', type:'ad', cluster:'Inflated balance', img:'assets/bold/pinch-1x1.jpeg', imgNote:'Bold creative · "Your debt may be less than they say" (1:1)',
  lp:'https://start.credolegal.com/credit-card-debt-negotiation',
  text:'Your debt may be less than they say. Interest, fees and collection charges get added along the way, and the number on the letter is not always the number you actually owe. You can ask the collector to show exactly how they got to it. We check the balance for free: start.credolegal.com/credit-card-debt-negotiation',
 ...
 {date:'2026-09-24', time:'21:00', status:'scheduled', src:'bold', type:'ad', cluster:'Collector breaking the law', img:'assets/bold/pointing-1x1.jpeg', imgNote:'Bold creative · "Your debt collector may be breaking the law" (1:1)',
  ...
  text:'Your debt collector may be breaking the law. The FDCPA sets rules for how collectors can contact you: no threats, no calls at odd hours, no talking to your neighbors or coworkers about your debt. Each violation can be worth up to $1,000 in statutory damages. If something about the calls feels off, our attorneys will look at them for free: start.credolegal.com/debt-harassment-fdcpa-attorney',
 ...
 {date:'2026-09-26', time:'17:00', status:'scheduled', src:'bold', type:'ad', cluster:'Check your debt for free', img:'assets/bold/offer-1x1.jpeg', imgNote:'Bold creative · "Check your debt for free" (1:1)',
  lp:'https://start.credolegal.com',
  text:'Not sure whether a debt is real, accurate, or even yours? Check it for free. Send us the letter or the collector\'s details and our attorneys will tell you whether the collector can back it up and what your options are. No upfront cost, no obligation. start.credolegal.com',
